...
<div class="card">
	...
	<div class="card-header card-header-stretch overflow-auto">
		...
		<ul class="nav nav-stretch nav-line-tabs fw-semibold fs-6 border-transparent flex-nowrap" role="tablist" id="kt_layout_builder_tabs">
                ...
                <li class="nav-item mt-2">
                    <a class="nav-link active text-active-primary ms-0 me-10 py-5 " href="/settings/language">
                        Languages                    </a>
                </li>
        ...
        <button class="btn btn-primary btn-sm " data-bs-toggle="modal" data-bs-target="#languageModal">
    Create
</button>

<!-- Modal for Language Dropdown -->
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <!-- Add your dropdown of languages here -->
