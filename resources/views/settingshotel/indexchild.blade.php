...
<div class="card">
	...
	<div class="card-header card-header-stretch overflow-auto">
		...
		<ul class="nav nav-stretch nav-line-tabs fw-semibold fs-6 border-transparent flex-nowrap" role="tablist" id="kt_layout_builder_tabs">
                ...
                <li class="nav-item mt-2">
                    <a class="nav-link active text-active-primary ms-0 me-10 py-5 " href="/settings/child">
                       Children                   </a>
                </li>
...
<div class="form-group">
        ...
        <div class="d-flex align-items-center" style="width: 70%;">
            ...
            <div style="flex: 1;">
                <label class="d-flex align-items-center fs-5 fw-semibold mb-2">
                    <span class="required">Are children allowed?</span>                    
                </label>
    ...
    <div class="d-flex align-items-center" style="width: 100%;">
        ...
        <div style="flex: 1;">
            <label class="d-flex align-items-center fs-5 fw-semibold mb-2">
                <span class="required">Age From</span>                    
            </label>
            <select class="form-control" name="age_from" style="width: 100%;">
        ...
        <div style="flex: 1; margin-left: 20px;">
            <label class="d-flex align-items-center fs-5 fw-semibold mb-2">
                <span class="required">Age To</span>
            </label>
            <select class="form-control" name="age_to" style="width: 100%;">
                <option value="1">1 year</option>
                <option value="2">2 years</option>
                <option value="3">3 years</option>
                <!-- Add more options as needed -->
