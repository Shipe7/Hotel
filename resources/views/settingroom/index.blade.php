...
<div class="card">
	...
	<div class="card-header card-header-stretch overflow-auto">
        ...
        <li class="nav-item mt-2">
                    <a class="nav-link  text-active-primary ms-0 me-10 py-5 " href="/roomsettings/room">
                        Room  Type                  </a>
                </li>

                <li class="nav-item mt-2">
                    <a class="nav-link active text-active-primary ms-0 me-10 py-5 " href="/roomsettings">
                        Room                   </a>
                </li>
