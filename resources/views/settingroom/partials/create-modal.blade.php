                        ...
                        <div class="col-md-9 ps-0">
                            ...
                            <div class="row">
                                ...
                                <label class="form-label fw-bold">Max Occupancy </label>
                                    <div class="position-relative" data-kt-password-meter="true">
                                        <input id="number" name="maxoccupancy" type="number" class="form-control" placeholder="4"/>
                                ...
                                <label class="form-label fw-bold">Default Occupancy</label>
                                    <div class="position-relative" data-kt-password-meter="true">
                                        <input id="number" name="occupancy" type="number" class="form-control" placeholder="4"/>
                            ...
                            <div class="col-md-6 mb-2 px-2">
                                ...
                                <label class="form-label fw-bold">Default Children</label>
                                    <div class="position-relative" data-kt-password-meter="true">
                                        <input id="number" name="children" type="number" class="form-control" placeholder=""/>
                            ...
                            <textarea class="form-control" rows="3" name="description" placeholder="Enter your description here" required></textarea>
                        </div>
