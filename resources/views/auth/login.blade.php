<x-layouts.auth>
    <div class="d-flex flex-center flex-column flex-column-fluid px-lg-10 pb-15 pb-lg-20" x-data="{ forgot: false, email: '' }">
        <form
            ...
            >
                ...
                <div class="fv-row mb-8">
                    <input type="text" placeholder="Email" name="email" required x-model="email"
                           class="form-control form-control-solid" aria-label="email"/>
                </div>
                <div class="d-flex flex-stack flex-wrap gap-3 fs-base fw-semibold my-8">
                    <div></div>
