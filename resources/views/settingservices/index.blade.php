...
<div class="card">
	...
	<div class="card-header card-header-stretch overflow-auto">
        ...
        <li class="nav-item mt-2">
                    <a class="nav-link active text-active-primary ms-0 me-10 py-5 " href="/Services">
                        Services                 </a>
                </li>

                <li class="nav-item mt-2">
                    <a class="nav-link  text-active-primary ms-0 me-10 py-5 " href="/category">
                        Category                   </a>
                </li>
    ...
    @include('settingservices.partials.create-modal')
