...
var KTChartsWidget18 = function () {
    ...
    var initChart = function(chart) {
        ...
        var options = {
            series: [{
                name: 'Spent time',
                data: [54, 42, 75, 110, 23, 87, 50, 70, 90, 34, 78]
            }],
            chart: {
                fontFamily: 'inherit',
                type: 'bar',
            ...
            xaxis: {
                categories: ['May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec', 'Jan', 'Feb', 'Mar'],
                axisBorder: {
                    show: false,
                },
                axisTicks: {
...
var KTChartsWidget27 = function () {
    ...
    var initChart = function(chart) {
        ...
        var options = {
            ...
            colors: ['#3E97FF', '#A71C1F', '#449C11', '#FFC700', '#7239EA'],
            xaxis: {
...
var KTChartsWidget5 = function () {
    ...
    var initChart = function(chart) {
        ...
        var options = {
            ...
            colors: ['#3E97FF', '#A71C1F', '#449C11', '#FFC700', '#7239EA', '#50CDCD', '#3F4254'],
            xaxis: {
